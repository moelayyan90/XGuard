...
app = FastAPI(title="TrimGate", version="1.0.0")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "trimgate", "model": os.getenv("GEMINI_MODEL", "gemini-3.5-flash")}
...
<title>TrimGate — Autonomous Print Production Gatekeeper</title>
<style>
