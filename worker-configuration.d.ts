/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/worker/wrangler.jsonc --env-interface=CloudflareBindings` (hash: 03bb31244a88bf48ac19c255755d42d8)
...
interface __BaseEnv_CloudflareBindings {
	...
	FACILITATORS_JSON: "[{\"id\":\"x402-org-testnet\",\"baseUrl\":\"https://x402.org/facilitator\",\"networks\":[\"eip155:84532\"],\"schemes\":[\"exact\"],\"costMicroUsd\":\"0\",\"priority\":100,\"exactEvmTransferMethods\":[\"eip3009\",\"permit2\"]}]";
	PAYMENT_COORDINATOR: DurableObjectNamespace<import("./apps/worker/src/index").PaymentCoordinator>;
	REQUEST_GATE: DurableObjectNamespace<import("./apps/worker/src/index").RequestGate>;
}
