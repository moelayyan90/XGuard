...
<section class="section" id="pilot"><span class="tag">DIRECT PILOT REQUEST</span><h2>Give us one workflow that wastes your team’s time.</h2><p class="intro">Submit the operation directly into XGuard. The request is stored in our operations queue, so this does not depend on email delivery.</p><form class="pilot" action="/v1/operations/pilot" method="post">
<div class="pilot-grid">
<div><label for="organisationName">Company *</label><input id="organisationName" name="organisationName" required maxlength="180" autocomplete="organization"></div>
<div><label for="contactName">Your name</label><input id="contactName" name="contactName" maxlength="160" autocomplete="name"></div>
<div><label for="contactEmail">Work email *</label><input id="contactEmail" name="contactEmail" type="email" required maxlength="254" autocomplete="email"></div>
<div><label for="countryCode">Country code</label><input id="countryCode" name="countryCode" maxlength="2" placeholder="DE"></div>
<div><label for="website">Company website</label><input id="website" name="website" maxlength="240" placeholder="https://example.com"></div>
<div><label for="estimatedMonthlyCases">Estimated cases / month</label><input id="estimatedMonthlyCases" name="estimatedMonthlyCases" type="number" min="0" max="100000000" inputmode="numeric"></div>
<div class="wide"><label for="workflowInterest">Workflow *</label><select id="workflowInterest" name="workflowInterest" required><option value="">Choose one</option><option value="eudr_operations">EUDR operations</option><option value="customs_operations">Customs operations</option><option value="government_operations">Government administration</option><option value="supplier_follow_up">Supplier follow-up</option><option value="compliance_operations">Compliance operations</option><option value="other">Other cross-border workflow</option></select></div>
<div class="wide"><label for="message">What should XGuard take off your team’s plate?</label><textarea id="message" name="message" maxlength="3000" placeholder="Describe the repetitive workflow, deadline, portal, documents or supplier chasing involved."></textarea></div>
<div class="trap" aria-hidden="true"><label for="contactFax">Fax</label><input id="contactFax" name="contactFax" tabindex="-1" autocomplete="off"></div>
<div class="wide"><button class="submit" type="submit">Submit pilot request</button></div>
</div></form></section>
...
<p class="foot">XGuard — smart cross-border operations, starting with EUDR.</p>
</main></body></html>`;
