...
// This surface is stateless and dual-compatible with A2A JSON-RPC 0.3 and 1.0 discovery clients.
// Merchant credentials and payment authorization are not consumed by this endpoint.
// No billing, settlement, or finality state is mutated here.
// Responses are informational integration guidance only.
