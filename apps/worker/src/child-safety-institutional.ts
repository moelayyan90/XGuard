...
function page(title: string, body: string): string {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)} — XGuard</title><style>${styles()}</style></head><body><header><a class="brand" href="/child-safety">XGuard.</a><nav><a href="/child-safety/compliance">Compliance</a><a href="/child-safety/pilot">Pilot</a><a href="/child-safety/pricing">Pricing</a><a href="/child-safety/reporting">Reporting</a><a href="/child-safety/rights">Rights</a></nav></header><main>${body}</main><footer><span>Protect children. Not monitor childhood.</span><span>info@xguardgate.com · support@xguardgate.com</span></footer></body></html>`;
}
...
function styles(): string {
  return `*{box-sizing:border-box}body{margin:0;background:#0a0b0d;color:#f7f7f7;font-family:Inter,Arial,sans-serif}header,footer{max-width:1180px;margin:auto;padding:24px 28px;display:flex;justify-content:space-between;gap:24px;align-items:center}.brand{font-size:24px;font-weight:800;color:#fff;text-decoration:none}nav{display:flex;gap:16px;flex-wrap:wrap}nav a,footer{color:#aeb3bd;text-decoration:none}main{max-width:1180px;margin:auto;padding:36px 28px 80px}.hero{padding:70px 0 48px;max-width:900px}.eyebrow{text-transform:uppercase;letter-spacing:.16em;color:#77a8ff;font-size:12px;font-weight:700}.hero h1{font-size:clamp(42px,7vw,86px);line-height:.98;margin:14px 0 24px}.hero p,.card p,.panel p,.step p{color:#b9bec7;font-size:18px;line-height:1.7}.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.card,.panel,.step,.partner{background:#121419;border:1px solid #252933;border-radius:18px;padding:26px}.panel{margin-top:24px}.steps{display:grid;gap:14px}.step{display:flex;gap:20px}.step>b{font-size:28px;color:#77a8ff}.partners{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.partner{display:flex;flex-direction:column;gap:8px;text-decoration:none;color:#fff}.partner span{color:#aeb3bd;line-height:1.5}.cta{margin-top:24px;padding:30px;border-radius:18px;background:#e8f1ff;color:#10141b}.cta a{color:#0b57d0}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:16px;border-bottom:1px solid #2b2f38}th{color:#8eb4ff}.note{font-size:14px!important}ul{color:#b9bec7;line-height:1.9}@media(max-width:760px){header{align-items:flex-start;flex-direction:column}.grid,.partners{grid-template-columns:1fr}.hero{padding-top:34px}.hero h1{font-size:44px}}`;
}
