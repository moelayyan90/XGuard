      ...
      inputSchema: {
        ...
        properties: {
          requestId: {
            ...
            minLength: 8,
            maxLength: 96,
            description: "Idempotency id for this decision.",
          },
          offerId: {
            type: "string",
            maxLength: 96,
            description: "Id from a prior XGuard offer.",
          },
          rail: {
            type: "string",
            minLength: 1,
            maxLength: 64,
            description: "Rail, e.g. card, x402, or bank_transfer.",
          },
          provider: {
            type: "string",
            minLength: 1,
            maxLength: 64,
            description: "Provider name or generic_http.",
          },
          amount: {
            type: "string",
            description: "Positive decimal amount; no credentials.",
          },
          currency: {
            type: "string",
            minLength: 2,
            maxLength: 12,
            description: "Amount unit, e.g. USD or USDC.",
          },
          payee: {
            type: "string",
            minLength: 1,
            maxLength: 256,
            description: "Merchant or payment recipient.",
          },
          merchantOrigin: {
            type: "string",
            maxLength: 512,
            description: "Optional merchant HTTPS origin.",
          },
          network: {
            type: "string",
            maxLength: 96,
            description: "Optional network, e.g. eip155:8453.",
          },
          asset: {
            type: "string",
            maxLength: 96,
            description: "Optional payment asset id.",
          },
          expectedAmount: {
            type: "string",
            maxLength: 64,
            description: "Expected amount for mismatch checks.",
          },
          expectedPayee: {
            type: "string",
            maxLength: 256,
            description: "Expected payee for mismatch checks.",
          },
          expiresAt: {
            type: "string",
            maxLength: 64,
            description: "Optional authorization expiry time.",
          },
          paymentReference: {
            type: "string",
            maxLength: 160,
            description: "Optional non-secret payment reference.",
          },
          metadata: {
            type: "object",
            maxProperties: 20,
            description: "Optional non-secret scalar context.",
