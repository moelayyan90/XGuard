/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6dd7153beac7d7a4adcdd032ce2d2145)
...
interface __BaseEnv_Env {
	...
	PAYMENT_IDENTIFIER_TTL_SECONDS: "86400";
	HEALTH_MAX_AGE_SECONDS: "900";
	FACILITATORS_JSON: "[{\"id\":\"x402-org-testnet\",\"baseUrl\":\"https://x402.org/facilitator\",\"networks\":[\"eip155:84532\"],\"schemes\":[\"exact\"],\"costMicroUsd\":\"0\",\"priority\":100,\"exactEvmTransferMethods\":[\"eip3009\",\"permit2\"]},{\"id\":\"payai-testnet\",\"baseUrl\":\"https://facilitator.payai.network\",\"networks\":[\"eip155:84532\"],\"schemes\":[\"exact\"],\"costMicroUsd\":\"0\",\"priority\":100,\"exactEvmTransferMethods\":[\"eip3009\"]}]";
	PAYMENT_COORDINATOR: DurableObjectNamespace<import("./src/index").PaymentCoordinator>;
	REQUEST_GATE: DurableObjectNamespace<import("./src/index").RequestGate>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PaymentCoordinator" | "RequestGate";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "XGUARD_FEE_MICRO_USD" | "PAYMENT_IDENTIFIER_TTL_SECONDS" | "HEALTH_MAX_AGE_SECONDS" | "FACILITATORS_JSON">> {}
}
