...
if (!health.ok || status.status !== "ready" || status.version !== "5.0.2" || status.webhook_signature !== "configured") throw new Error(`Billing is not ready: HTTP ${health.status} ${JSON.stringify(status)}`);
