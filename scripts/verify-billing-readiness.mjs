...
if (!health.ok || status.status !== "ready" || status.version !== "5.2.0" || status.webhook_signature !== "configured") throw new Error(`Billing is not ready: HTTP ${health.status} ${JSON.stringify(status)}`);
