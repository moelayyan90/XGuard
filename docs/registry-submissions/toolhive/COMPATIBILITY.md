...
- XGuard MCP endpoint: `https://xguard-mainnet.maqamapp.workers.dev/mcp`
...
```text
thv run https://xguard-mainnet.maqamapp.workers.dev/mcp --name xguard-toolhive-smoke --proxy-port 18080 --transport streamable-http
```
