...
XGuard's primary product is the **Agent Execution Gateway**. This WordPress connector uses XGuard's native x402 v2 compatibility surface so a site can select XGuard without changing the seller's configured receiving wallet or price.
